...
class OCRPredictorNative {

    private static final AtomicBoolean isSOLoaded = new AtomicBoolean();

    protected static void loadLibrary() throws RuntimeException {
    ...
    protected OCRPredictorNative(Config config) {
        this.config = config;
        loadLibrary();
    ...
    protected ArrayList<OcrResultModel> runImage(Bitmap originalImage, int max_size_len, int run_det, int run_cls, int run_rec) {
    ...
    protected static class Config {
        protected int useOpencl;
        protected int cpuThreadNum;
        protected String cpuPower;
        protected String detModelFilename;
        protected String recModelFilename;
        protected String clsModelFilename;
